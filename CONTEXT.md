...
开发路线图见 [`docs/roadmap.md`](docs/roadmap.md)。阶段 0/1 已完成，**阶段 2 进行中**（2.1/2.2 已实现）。

| # | 候选 | 优先级 | 问题 | 状态 |
|---|------|--------|------|------|
| 1 | 大纲可视区域高亮 | 中 | 滚动正文时 Outline 高亮当前节（阶段 2.1） | 已完成 |
| 2 | 欢迎页 Recent Files | 中 | 数据已有，UI 缺失（阶段 2.2） | 已完成 |
| 3 | CLI 参数恢复 | 低 | Electron 时代有，Tauri 版丢失（阶段 2.3） | 待做 |
