...
GFM 渲染、KaTeX、Mermaid、多标签、文件树、全文搜索、大纲导航、主题切换、状态恢复、原生菜单、阅读设置（字体大小/行高/页宽）、6 套内置主题、命令面板（Ctrl+Shift+P）、HTML/PDF 导出、每日笔记、多工作区、Markdown 编辑器（Edit 模式）、自动保存、冲突检测、查找替换、多光标编辑等。
