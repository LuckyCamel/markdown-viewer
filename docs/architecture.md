...
| SourceViewer      | `features/markdown-viewer/SourceViewer.tsx`     | 文本/代码文件源码查看、语法高亮、行号显示、搜索行定位与高亮                                                                 | 浅     | highlight.js                                                      |
...
| ScrollContainer   | `shared/scrollContainer.ts`                     | 滚动容器工具函数（按元素/行号/锚点滚动），支持 Markdown 正文和 SourceViewer 两种场景                                        | 浅     | —                                                                 |
